...
export default function Montreal() {
  ...
  return (
    <>
      ...
      <Titre className={appMode + "-mode"}>MONTREAL</Titre>
      <Titre className={appMode + "-mode"}> Centre Bell 03-03-2024 </Titre>
      <Image src="/montreal.jpg" width={550} height={350} alt="centre bell" />
      <Description className={appMode + "-mode"}>
      {data[appLang].montreal[0]}
      </Description>
    </>
  );
}
